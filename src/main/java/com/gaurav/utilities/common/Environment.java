package com.gaurav.utilities.common;
...
public class Environment {
	...
	{
		try {
			 	InputStream input = new FileInputStream(System.getProperty("user.dir")+"/src/main/java/com/gaurav/properties/common/"+System.getProperty("TestEnv")+".properties");
